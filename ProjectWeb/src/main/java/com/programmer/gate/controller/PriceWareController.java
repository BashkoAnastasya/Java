...
public class PriceWareController {
	...
	public String saveSupplier(@RequestParam Integer id, @RequestParam String dbeg,  @RequestParam String dend, @RequestParam BigDecimal price, @RequestParam (name="ware") int ware_id 
			) {
